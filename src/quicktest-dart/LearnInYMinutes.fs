...
// let r1 = square 3                      // Now run the function. Again, no parens.

// let add x y = x + y           // don't use add (x,y)! It means something
//                               // completely different.
// let r2 = add 2 3                       // Now run the function.

// let add3 x y z = x + y + z
// // Partial produces a new function from an existing function and some of its arguments.
